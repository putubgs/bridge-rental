...
export default function Footer() {
  ...
  return (
    <div className="bg-[#F9F9F9] px-4 pb-10 pt-10 md:bg-black lg:-mt-20 lg:px-20 lg:pb-10 lg:pt-20">
      <footer className="mx-auto flex max-w-screen-2xl flex-col gap-10 text-white lg:gap-20">
        ...
        <div className="grid grid-cols-1 divide-y divide-neutral-300 lg:grid-cols-3 lg:divide-x lg:divide-y-0 [&>div]:py-5">
          ...
          <div className="flex flex-col items-start py-5 lg:items-center lg:justify-center">
            <div className="space-y-1">
              <h2 className="font-semibold text-black lg:text-white">
                Telephone
        ...
        {/* Footer Bottom */}
        <div className="flex flex-col items-center justify-center gap-5 border-t border-neutral-300 pt-5 text-sm text-neutral-500 lg:flex-row lg:justify-between lg:border-neutral-700">
